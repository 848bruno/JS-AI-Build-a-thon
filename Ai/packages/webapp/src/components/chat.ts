...
export const chatDefaultOptions: ChatComponentOptions = {
  ...
  promptSuggestions: [
    'link for home workout videos ?',
    'What is the key to strength training is performing challenging exercises for repetitions and multiple sets?',
    'how to maintain strength without equipment while away at home?',
    'what are Basics of Nutrition and Exercise',
  ],
  messages: [],
  strings: {
